...
<script>
	...
	function uploadNext() {
		...
		xhr.open("POST", "/ServletPratice/SectionB/MultipleUploads");
...
<body>
	...
	<form id='form1' action="/SectionB/MultipleUploads" enctype="multipart/form-data"
		method="post">
	...
	<div id='debug'
		style='height: 100px; border: 2px solid green; overflow: auto'></div>
</body>
</html>